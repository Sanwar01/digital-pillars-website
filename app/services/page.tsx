  ...
  return (
    <div data-testid="services-page">
      ...
      <section className="mx-auto max-w-[1400px] px-6 pb-16 pt-40 md:px-10 md:pb-24 md:pt-52">
        <p className="overline text-brand-cyan">{services.hero.eyebrow}</p>
        <h1 className="mt-6 max-w-5xl font-display text-[12vw] leading-[0.9] sm:text-[9vw] lg:text-[7vw]">
          <KineticHeadline lines={[...services.hero.lines]} />
        </h1>
        <Reveal delay={0.4}>
              ...
              <Reveal key={s.id}>
                ...
                >
                  ...
                  <div className="md:col-span-5">
                    <Icon
                      className="mb-6 h-9 w-9 text-brand-cyan"
                      strokeWidth={1.4}
                    />
                  ...
                  <div className="md:col-span-6">
                    <ul className="grid grid-cols-1 gap-px overflow-hidden rounded border border-white/10 bg-white/10 sm:grid-cols-2">
                      {s.points.map((p) => (
                        <li
                          key={p}
                          className="flex items-center gap-3 bg-brand-navy p-5 text-white/80"
                        >
      ...
      >
        <Reveal className="mb-14">
          <p className="overline text-brand-cyan">{services.process.eyebrow}</p>
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-24 md:px-10 md:py-32">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:gap-10">
            <Reveal className="md:col-span-4">
              <p className="overline text-brand-cyan">{services.faq.eyebrow}</p>
              <h2 className="mt-5 font-display text-4xl leading-tight sm:text-5xl">
                {services.faq.headline}
              </h2>
            </Reveal>
            <div className="md:col-span-8">
              <Accordion className="w-full">
                {services.faq.items.map((f, i) => (
                  <AccordionItem
                    key={i}
                    value={`item-${i}`}
