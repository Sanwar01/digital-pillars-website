export const services = {
  ...
  hero: {
    eyebrow: 'Services',
    lines: ['Everything you need', 'to win online.'],
    body: 'Four connected disciplines that take you from idea to impact — strategy, design, engineering and automation under one Manchester roof.',
  },
  process: {
    eyebrow: 'How it works',
    headline: 'A process built for momentum.',
    steps: [
      {
        no: '01',
        title: 'Discover',
